...
// == Composant
const ModalNoFastFood = ({ manageAddResolution, addNewResolution, onHide }) => {
    ...
    <div>
      ...
      <div className="resolutions-content-step2">
        <div className="one-resolution-step2">
          <img className="resolution-image-step2" src={cook} alt="" />
          <h5 className="titleResolution-step2">Je mange moins de fast food</h5>
        </div>
        <div className="choiceResolution">
          <div className="choiceResolutionButtons">
            <button type="button" onClick={handleClickResolutionButton} className="choiceResolutionButton" name={nameResolution} id="115">Manger mieux !</button>
            <button type="button" onClick={handleClickResolutionButton} className="choiceResolutionButton" name={nameResolution} id="116">je mange un bon repas par jour</button>
          </div>
...
// == Export
export default connect(mapStateToProps, mapDispatchToProps)(ModalNoFastFood);
